...
import '../../features/profile/presentation/psyche_preferences_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Поведенческие предпочтения (частота/стиль/фокус-часы).
      GoRoute(path: '/profile/preferences', builder: (_, _) => const AuthGuard(child: PsychePreferencesScreen())),
