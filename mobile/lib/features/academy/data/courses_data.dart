  ...
  lessons: [
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Главный конкурент золота — облигации'),
        _p('У золота есть «недостаток»: оно не платит процентов. Поэтому его главный соперник — '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Межрыночный анализ'),
        _p('Профи смотрят не на один график, а на связи между рынками (intermarket analysis): '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _rule(
          ...
          title: 'Теорема Байеса в действии',
        ),
        _fact(
    ...
    CourseLesson(
      ...
      quiz: const QuizQuestion(
        ...
        options: [
          ...
          'В реинвестировании прибыли — экспоненциальный рост на дистанции',
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _story(
          ...
          'сожаления о неудаче.',
          title: 'Гараж, который стал триллионом',
        ),
      ],
      quiz: const QuizQuestion(
  ...
  lessons: [
    CourseLesson(
      ...
      blocks: [
        ...
        _p('Взлёт: после двух мировых войн США оказались единственной крупной экономикой без '
            'разрушений на своей территории. Они создали Бреттон-Вудскую и нефтедолларовую '
            'системы, закрепив доллар в центре мира.'),
        _p('Особенность: культура потребления и предпринимательства, Кремниевая долина, '
            'венчурный капитал, статус USD как «всемирного кошелька».'),
        const CardsBlock('4 секрета американского успеха', [
          CardItem('🔬', 'Инновации', 'Эдисон, Форд, Джобс, Маск. США — магнит для лучших умов мира.'),
          CardItem('🌍', 'Иммиграция талантов', 'Google основал россиянин Сергей Брин, Yahoo — тайванец Джерри Янг.'),
          CardItem('⚖️', 'Верховенство права', 'Защита собственности и контрактов. Бизнес доверяет системе.'),
          CardItem('💵', 'Сила доллара', 'Мировая резервная валюта — Америка занимает у всего мира.'),
        ]),
        _fact(
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _p('Взлёт: восстановление с помощью США, корпорации-кейрецу, культ качества (Toyota, '
        ...
        _story(
          ...
          title: '34 года, чтобы вернуться в ноль',
        ),
        _rule(
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _p('Взлёт: гений Ли Куан Ю, который превратил коррумпированный портовый город в '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _p('Взлёт: реформы Дэн Сяопина с 1978 года, свободные экономические зоны, дешёвая '
        ...
        _p('Особенность: долгие годы Китай искусственно удерживал курс юаня заниженным, чтобы '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _p('Взлёт: чудо 1950-х, план Маршалла, денежная реформа и культура труда. Германия '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        const CardsBlock('4 опоры экономики Казахстана', [
          CardItem('🛢️', 'Ресурсы', 'Нефть, газ, уран (№1 в мире!), медь, золото. Сырьевой фундамент.'),
          CardItem('🚉', 'Транзит', 'Мост между Китаем и Европой — Новый Шёлковый путь идёт через нас.'),
          CardItem('🌾', 'Агро', 'Один из крупнейших экспортёров пшеницы в мире.'),
          CardItem('🧑‍💻', 'Молодёжь', 'Молодая нация, рост IT (Astana Hub) и финтеха (Kaspi).'),
        ]),
        _fact(
        ...
        _p('Возможность для тебя: финансовая грамотность и инвестиции — это и есть личная '
      ...
      quiz: const QuizQuestion(
        question: 'В чём суть «ресурсного проклятия» для экономики Казахстана?',
        options: [
          'Слишком мало природных ресурсов',
          'Зависимость от цен на сырьё делает экономику уязвимой; нужна диверсификация',
          'Ресурсы быстро заканчиваются за год',
          'Ресурсы запрещено экспортировать',
        ],
        correctIndex: 1,
        explanation:
