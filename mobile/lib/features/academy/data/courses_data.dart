    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Сенің миың миллиондаған жыл бойы алтын саудаламақ үшін емес, саваннада өмір сүру '
          'үшін жасалды. Ақшаға төнген кез келген қауіпке ол жолбарысқа сияқты әрекет етеді: '
        ...
        _p(_lt(
          ...
          'Бауырымен жорғалаушы ми — өмір сүру, инстинкт. Лимбиялық жүйе (амигдала) — эмоция, '
        ...
        _fact(_lt(
          ...
          'Дофамин — рахат емес, КҮТУ гормоны. Ол ықтимал сыйақы алдында шығады. Сондықтан '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'Стресс амигдаланы белсендіреді (amygdala hijack), кортизол шығады, рационал '
          'неокортекс уақытша бақылауды жоғалтады. Қорғаныс — алдын ала дайын жоспар және '
          'автоматты стоптар.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'прибыли.',
          'Бүкіл нарық, мәні бойынша, тобырдың екі эмоциясы арасында тербеледі: қорқыныш пен '
        ...
        _fact(_lt(
          ...
          'Ресми «Қорқыныш пен ашкөздік индексі» (CNN Fear & Greed Index) бар, ол нарық көңіл-'
          'күйін 0-ден (шектен тыс қорқыныш) 100-ге (шектен тыс ашкөздік) дейін өлшейді. Тарихи '
        ...
        _story(_lt(
          ...
          '«Етік тазалаушы индикаторы» бар. 1929 күйреуінің алдында Джозеф Кеннеди (болашақ '
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          '«Тильт» — покер термині: зияннан кейін эмоция үстемдік алып, «қайтарып алмақ» болып '
        ...
        _warn(_lt(
          ...
          'Revenge trading (кек саудасы) — ең қымбат эмоциялық сбой. Нарыққа қанша жоғалтқаның '
        ...
        _fact(_lt(
          ...
          'Проп-фирмалардағы кәсіби трейдерлер қатаң ережемен жұмыс істейді: күндік зиян лимиті '
          'олардың терминалға қолжетімін автоматты жабады. Бұл сенімсіздік емес — кәсіпқойда да '
          'тильт болатынын және одан ерік-жігер емес, жүйе деңгейінде қорғаныс керегін мойындау.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'көлеммен кіру. Бұл тильт спиралі. Қорғаныс — стоп-күн және зияннан кейінгі үзілістер.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Біздің ми энергияны үнемдеу үшін «жылдам шаблондар» (эвристикалар) қолданады. '
        ...
        _fact(_lt(
          ...
          'Даннинг-Крюгер эффектісі: тәжірибесі аз жаңадан бастаушылар өз дағдысын ең қатты '
          'асыра бағалайды — «ақымақтық шыңы». Дәл сондықтан көпшілік алғашқы сәтті серияның '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'Мәмілені «нөлден» бағалаған дұрыс, жоғалтқанға жабыспау керек.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'автоматическим.',
          'Тәртіп — «темір адамдардың» туа біткен сыйы емес, бұлшықеттей жаттығатын дағды. '
        ...
        _fact(_lt(
          ...
          'Зерттеулер ерік-жігер таусылатын ресурс екенін көрсетеді («эго сарқылуы»). Шартты '
          'мерзімінен босату судьялары түскі ас алдында, аш әрі шаршаған кезде едәуір қатаң '
        ...
        _story(_lt(
          ...
          'слабости.',
          'Аты аңызға айналған трейдер Пол Тюдор Джонс қабырғада «Losers average losers» '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'сәттік мотивацияға тәуелсіз автоматты етеді.',
        ),
      ),
    ),
  ],
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Индикатор салмас бұрын нарық құрылымын — бағаның ең базалық әрі шынайы тілін түсіну '
        ...
        _fact(_lt(
          ...
          'Нарық құрылымы тұжырымдамасы барлық индикатордан көне. XX ғасыр басында-ақ Чарльз Доу '
          '(Wall Street Journal мен Dow Jones индексінің негізін қалаушы) «Доу теориясын» '
          'тұжырымдады, оның негізінде — сол өсетін/төмендейтін максимумдар мен минимумдар. '
          'Қазіргі Smart Money — қайта оралған классика.',
        )),
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Ірі ойыншыға (банкке, қорға) ОРАСАН ордерді орындау керек. Бірақ ол жай нарықпен '
          'сатып алса, ол позицияны жинамай тұрып баға жоғары ұшып кетеді. Оған қарсы өтімділік '
        ...
        _p(_lt(
          ...
          'Айқын минимумдардың астында және айқын максимумдардың үстінде. Дөңгелек деңгейлердің '
        ...
        _fact(_lt(
          ...
          '«Stop hunt» терминін ұзақ уақыт қастандық теориясы деп санады — реттеушілер ірі '
          'банктерді алтын мен форекс нарығындағы манипуляция үшін миллиардтаған долларға '
          'айыппұл салғанша (Лондон алтын фиксингімен манипуляция ісі). Стоптарға аң аулау — '
          'трейдерлердің параноясы емес, нақты тәжірибе болып шықты.',
        )),
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'Ірі ордерге қарсы өтімділік керек. Минимум астында тобыр стоптарын ұшыра отырып, '
          'ойыншы позиция жинауға жеткілікті қарсы ордер алады, содан кейін баға бұрылады.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Ірі ойыншы нарыққа кіргенде із қалдырады — қуатты импульс басталған аймақтар. Бұл '
        ...
        _p(_lt(
          ...
          'Order Block (ордер-блок) — күшті импульс қозғалысының алдындағы соңғы шам. Дәл осында '
        ...
        _p(_lt(
          ...
          'Fair Value Gap / Imbalance (FVG) — баға сонша жылдам қозғалып, толыққанды саудасыз '
        ...
        _warn(_lt(
          ...
          'Графикті ондаған ордер-блок пен FVG ботқасына айналдырма. Бұл тұжырымдар өздігінен '
        ...
        _fact(_lt(
          ...
          'модных терминов.',
          'Smart Money (SMC/ICT) терминологиясының көбі — институционалды трейдерлер ондаған жыл '
          'басқа атаумен жасап келгеннің қайта түсінілуі: ордер-блок, мәні бойынша, сұраныс/ұсыныс '
          'аймағы, ал имбаланс — гэптің бір түрі. Мән сәнді терминдерден маңызды.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'толтыруға жиі оралады, бұл кіру нүктелерін береді.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Алтын нарығы тәулік бойы дерлік саудаланады, бірақ барлық сағат бірдей емес. Көлем, '
        ...
        _fact(_lt(
          ...
          'Статистикалық байқалатын «қабаттасу эффектісі» бар: Лондон мен Нью-Йорк қатар '
        ...
        _warn(_lt(
          ...
          'Азиялық сессия мен түнгі кеш уақыт — тар диапазон мен жалған қозғалыс уақыты. Түнгі '
          '3-те зеріккеннен саудалайтын жаңадан бастаушы көбіне брокерге спред қана асырайды. '
          'Кіру сапасы экран алдындағы сағат санынан маңызды.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'ең белсенді, негізгі қозғалыстар сонда туады.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'разворот.',
          'Баға НЕ болғанын көрсетеді, ал көлем — оның ҚАНШАЛЫҚ маңызды екенін. Үлкен көлемдегі '
        ...
        _p(_lt(
          ...
          'движения.',
          'Спот форекс пен CFD-де «нағыз» биржалық көлем жоқ — брокер тек тиктік көлемді (баға '
        ...
        _fact(_lt(
          ...
          '«Көлем бағадан озады» қағидасы Ричард Вайкоффтың 1910-шы жылдары жасаған әдісінің '
          'негізінде жатыр. Вайкофф «лентаны оқуды» — мәмілелер ағынынан ірі оператордың '
        ...
        _warn(_lt(
          ...
          'Төмен көлемдегі жалған пробив (fakeout) — классикалық тұзақ. Тобыр «маңызды деңгейдің '
          'бұзылуын» көреді, мәмілеге секіреді, дәл сонда баға бұрылып, олардың стоптарын ұшырады. '
          'Әрдайым сұра: осы қозғалыстың артында көлем бар ма?',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'жалған болып шығады әрі стоптарды ұшыруға қызмет етеді.',
        ),
      ),
    ),
  ],
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Дродаун (drawdown) — капиталдың шыңнан түсуі. Трейдингтің басты контринтуитивті '
        ...
        _formula(_lf(
          ...
          [
            'Қалпына келу = Зиян / (100 − Зиян) × 100',
            '',
            '−10% → +11% керек',
            '−25% → +33% керек',
        ...
        _fact(_lt(
          ...
          'Математикадан бөлек психологиялық шұңқыр бар: −50% просадкадан кейін көп трейдер '
          'енді тыныш саудалай алмайды. Қорқыныш пен «қайтарып алу» ниеті тәртіпті бұзады, әрі '
          'нақты қалпына келу таза арифметика талап еткеннен де аз ықтимал болады.',
        )),
        _interactive('drawdown', title: 'Математика просадки'),
      ],
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'қалғанын екі еселеу керек. Сондықтан терең просадкалар осынша қауіпті.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Позиция мөлшері — әр мәміледегі №1 шешім, кіру нүктесінен маңызды. Кәсіпқой алдымен '
        ...
        _p(_lt(
          ...
          'Алтынға лонг, долларға (DXY) шорт және күміске лонг ашсаң — үш түрлі мәмілең бар '
        ...
        _warn(_lt(
          ...
          'Корреляцияланған позициялар нақты тәуекелді жасырады. Мәміле санын емес, тәуелсіз '
        ...
        _fact(_lt(
          ...
          'Гарри Марковиц «қазіргі портфель теориясы» үшін Нобель сыйлығын алды, '
          'әртараптандырудың құнын математикалық дәлелдеді. Оны жиі «инвестициядағы жалғыз '
          'тегін түскі ас» дейді: дұрыс таңдалған корреляцияланбаған активтер күтілетін '
          'табыстылықты төмендетпей тәуекелді азайтады.',
        )),
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Журналсыз сен трейдер емес, тек ұтыстарды есте сақтап, сәтсіздіктерді ұмытатын '
          'ойыншысың. Сауда журналы — сенің саудаң туралы ШЫНДЫҚТЫ әсіресіз әрі өзін-өзі '
        ...
        _fact(_lt(
          ...
          'Көп кәсіби қор трейдер журналдарын талдау үшін бөлек адамдар мен психологтар жалдайды '
          '— олар паттерн іздейді: трейдер тәуліктің қай уақытында, қай көңіл-күйде, қай '
        ...
        _example(_lt(
          ...
          'Трейдер стратегиясы зиянды деп сенімді болды. Журнал керісінше көрсетті: стратегия '
          'өзі пайдалы, бірақ барлық зиян жұма кештері «жүйеден тыс» импульсивті мәмілелерден '
          'келеді. Шешім қарапайым болды — сол уақытта саудаламау. Журналсыз ол жұмыс істейтін '
          'стратегияны лақтырып тастар еді.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'бойынша зиян сөзсіз әрі қалыпты; ең бастысы — ережелерді сақтадың.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Ақшаны тәуекелге салмас бұрын стратегияны тексеру керек. Бэктест — стратегияны '
          'тарихи деректерде жүргізу. Форвард-тест — нақты уақыттағы жаңа деректерде тексеру '
        ...
        _warn(_lt(
          ...
          'Басты тұзақ — шамадан тыс оңтайландыру (curve fitting). Параметрлерді өткенге сонша '
        ...
        _fact(_lt(
          ...
          'Екі нобель лауреаты басқарған атышулы LTCM қорында тарихи деректерде мінсіз '
          'математикалық модельдер болды. 1998 жылы шындық (Ресей дефолты) «тарихта болмаған» '
        ...
        _example(_lt(
          ...
          'рынка.',
          'Трейдер 2020–2021 бұқа нарығында мінсіз жұмыс істейтін жүйе құрады. Ол масаттанып, '
          'бар қаражатымен кіреді. Бірақ 2022 нарығы аю болды — құлдырау нарығында тексерілмеген '
          'жүйе депозитті құртады. Сабақ: барлық нарық түрінде тестіле.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'периодах.',
          'Curve fitting — тарихи шуға шамадан тыс икемдеу. Мұндай жүйе бэктестте жарқырайды, '
          'бірақ шындықта құлайды. Қорғаныс — форвард-тест және әртүрлі кезеңдерде тексеру.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Сауда жоспары — сенің трейдингіңнің конституциясы. Ол хаосты шешімдерді қайталанатын '
        ...
        _fact(_lt(
          ...
          'Авиацияда чек-листтер 1935 жылғы апаттан кейін пайда болды: ұшқыш рульдің бекітпесін '
          'алуды ұмытқандықтан жаңа Boeing бомбалаушысы құлады. Ұшақ «бәрін есте ұстауға тым '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'жоқ. Бұл эмоция әсеріндегі импульсивті шешімдерден қорғаныс.',
        ),
      ),
    ),
  ],
    ...
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Рэй Далио, әлемнің ең ірі Bridgewater хедж-қорының негізін қалаушы, экономиканы '
          'қарыз циклдары арқылы түсіндіреді. Қысқа цикл (~5–8 жыл, кәдімгі рецессиялар) және '
        ...
        _mechanic(_lt(
          ...
          'Несие — өсудің отыны. Қарызға алғанда тапқаныңнан көп жұмсап, экономиканы '
        ...
        _rule(_lt(
          ...
          'наличных — теряют.',
          'Үлкен циклдің соңында қарыздар көтеруге келмейтін болады. Мемлекеттің шығар жолы бар: '
        ...
        _fact(_lt(
          ...
          'на годы.',
          'Далио 12 жасында гольф алаңында кедди болып, инвесторлардың кеңесін тыңдап саудадан '
          'бастады. Бүгінде оның радикалды ашықтық және экономика «машинасын» циклдар арқылы '
          'зерттеу қағидалары тегін таратылатын кітаптарда жазылған. Оның «How the Economic '
          'Machine Works» видеосы вуздар жылдарға созатынды 30 минутта түсіндіреді.',
        )),
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'способность.',
          'Суперцикл соңында қарыздар ақша басумен (инфляциямен) құнсызданады. Бұл фазада алтын '
          'мен нақты активтер ұтады, ал қолма-қол ақша мен облигация сатып алу қабілетін '
          'жоғалтады.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Ақша тарихы — бірін-бірі алмастыратын резервтік валюталар тарихы. Бірде-бірі мәңгі '
          'билемеді. Голланд гульдені, испан песосы, британ фунты — бәрі өз дәуірінің «әлемдік '
        ...
        _p(_lt(
          ...
          'Көшбасшы ел соғыс/сауда ұтады → валютасы резервтік болады → «шектен тыс артықшылық» '
        ...
        _p(_lt(
          ...
          'Валюталық соғыс — елдер экспортты арзандатып, нарықты жаулау үшін валюталарын әдейі '
        ...
        _fact(_lt(
          ...
          'мгновенной и тихой.',
          'Фунт стерлинг Британ империясының шыңында 100 жылдан астам әлемдік резервтік валюта '
          'болды. Екі дүниежүзілік соғыс пен отарларды жоғалтқаннан кейін ол долларға орын берді. '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'кезеңдерінде алтын — «тусыз ақша» — құрылымдық сұраныс алады.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'Бүгінде алтынның ең ірі сатып алушылары — жеке инвесторлар емес, мемлекеттердің '
        ...
        _p(_lt(
          ...
          'Алтын — біреудің міндеттемесі болмайтын, санкциямен мұздатуға немесе бөгде баспа '
          'станогымен құнсыздандыруға келмейтін жалғыз резервтік актив. 2022 жылы Ресей '
        ...
        _fact(_lt(
          ...
          '2022–2023 жылдары әлем орталық банктері алтынды жарты ғасырдағы рекордты қарқынмен — '
        ...
        _p(_lt(
          ...
          'поддерживает золото.',
          'Де-долларизация — доллардың әлемдік сауда мен резервтегі рөлін біртіндеп азайту '
          'процесі. БРИКС елдері ұлттық валютамен есеп айырысуды және ішінара алтынмен '
      ...
      quiz: QuizQuestion(
        ...
        explanation: _lt(
          ...
          'де-долларизации.',
          'Алтын — біреудің міндеттемесі болмайтын актив. Оны мұздатуға да, басып шығаруға да '
          'болмайды. Резервтер мұздатылғаннан кейін бұл де-долларизацияның негізгі дәлеліне '
          'айналды.',
        ),
      ),
    ),
    CourseLesson(
      ...
      blocks: [
        _essence(_lt(
          ...
          'целого поколения.',
          'Әлемдегі капитал «қағаз» активтер (акция, облигация) мен «нақты» активтер (шикізат, '
          'металл, энергия, алтын) арасында циклмен ауысады. Бұл үлкен толысу мен қайтулар — '
        ...
        _p(_lt(
          ...
          'Өндіруге ұзақ жылдар аз инвестиция → шикізат тапшылығы → жылдар бойы баға өсімі → '
        ...
        _fact(_lt(
          ...
          '1980 жылы, тауар суперциклі мен инфляция шыңында, акциялар сонша танымал болмады — '
          'BusinessWeek журналы «Акциялардың өлімі» (The Death of Equities) мұқабасымен шықты. '
        ...
        _example(_lt(
          ...
          'Әр суперцикл өз «жұлдызын» туады: 1970-ші мұнай, 1980-ші жапон акциялары, 1990-шы '
          'доткомдар, 2000-шы шикізат пен алтын. Үлкен циклдің қай фазасында екенімізді түсіну '
          'кез келген күнішілік сигналдан маңызды.',
        )),
      ],
      quiz: QuizQuestion(
        question: _lt(
        ...
        explanation: _lt(
          ...
          'құнды қағаздан жақсы сақтайды. Алтын — осы кластың флагманы.',
        ),
      ),
    ),
  ],
