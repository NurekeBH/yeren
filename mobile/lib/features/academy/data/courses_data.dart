...
final Course _mastersOfUncertainty = Course(
  ...
  subtitle:
      'Фундаментальный анализ, макроэкономика, психология и математика решений для трейдеров',
  description:
      'Большой системный курс: как устроена глобальная финансовая машина, как читать '
      'экономический календарь, торговать XAU/USD, думать вероятностями, побеждать '
      'собственный мозг, видеть следы крупного капитала и зарабатывать на кризисах. '
      '10 модулей, каждый урок — теория, реальные истории, интересные факты, интерактив и тест.',
  priceBonus: 4900,
  accent: 0xFF2563EB,
  modules: [
    _module1,
  ...
  lessons: [
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Главные баги трейдера'),
        _p('• Confirmation bias (подтверждение): ищешь только ту информацию, что подтверждает '
            'твою сделку, игнорируя противоречащую. Купил золото — читаешь только бычьи прогнозы.'),
        _p('• Loss aversion (неприятие потерь): боль от потери в ~2 раза сильнее радости от '
            'выигрыша. Поэтому держишь убытки и рано режешь прибыль.'),
        _p('• Anchoring (якорение): цепляешься за цену входа как за «справедливую», хотя рынку '
            'на неё плевать.'),
        _p('• Sunk cost (невозвратные затраты): «я уже столько потерял на этой сделке, нельзя '
            'выходить сейчас» — и теряешь ещё больше.'),
        _p('• Recency bias (свежесть): переоцениваешь последние события. Три выигрыша подряд → '
            '«я гений» → завышаешь риск.'),
        _fact(
