  ...
  lessons: [
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Зачем вообще придумали деньги'),
        _p('Представь мир без денег — чистый бартер. Ты сапожник и хочешь хлеба. Но пекарю '
        ...
        _p('Деньги решили эту проблему: они стали универсальным посредником, который примет '
            'каждый. Деньги выполняют три функции: средство обмена, мера стоимости и средство '
            'накопления.'),
        _h('Три эпохи денег'),
        _p('1. Товарные деньги: ракушки каури, скот, соль, зерно. Само латинское слово '
            '«salarium» (зарплата) происходит от соли, которой платили римским солдатам — '
            'отсюда английское «salary».'),
        _p('2. Золотой стандарт: бумажные банкноты были «расписками» на золото в хранилище. '
            'До 1971 года доллар официально менялся на золото по фиксированному курсу '
            '\$35 за унцию.'),
        _p('3. Фиатные деньги (с 1971 г.): «fiat» на латыни — «да будет так». Деньги обеспечены '
        ...
        _story(
          ...
          title: 'Когда деньги стали мусором',
        ),
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Как доллар захватил мир'),
        _p('Бреттон-Вудс (1944): пока в Европе ещё шла война, 44 страны договорились привязать '
            'свои валюты к доллару, а доллар — к золоту. США тогда владели ~70% мирового золота, '
            'так что выбор был логичным.'),
        _p('Ямайская система (1976): после Никсоновского шока золотую привязку официально '
            'похоронили. Валюты стали «плавающими» — их курс определяет рынок.'),
        _p('Нефтедоллар (1970-е): США договорились с Саудовской Аравией, что нефть будет '
    ...
    CourseLesson(
      ...
      blocks: [
        ...
        _h('Где торгуется золото'),
        _p('Спотовый рынок (LBMA в Лондоне) — поставка золота «здесь и сейчас». Фьючерсы '
        ...
        _p('Розничный трейдер торгует через брокера CFD — контракт на разницу цен, без реальной '
        ...
        _story(
          ...
          title: 'Триллион долларов за 5 минут',
        ),
        _fact(
      ...
      quiz: const QuizQuestion(
        question: 'Почему крупный ордер на «тонком» стакане вызывает резкий скачок цены?',
        options: [
...
// ════════════════════════════════════════════════════════════════════
final CourseModule _module6 = CourseModule(
  id: 'm6',
  index: 6,
...
// ════════════════════════════════════════════════════════════════════
final CourseModule _module7 = CourseModule(
  id: 'm7',
  index: 7,
...
// ════════════════════════════════════════════════════════════════════
final CourseModule _module8 = CourseModule(
  id: 'm8',
  index: 8,
...
// ════════════════════════════════════════════════════════════════════
final CourseModule _module9 = CourseModule(
  id: 'm9',
  index: 9,
...
// ════════════════════════════════════════════════════════════════════
final CourseModule _module10 = CourseModule(
  id: 'm10',
  index: 10,
